...
public class Queries {
    ...
    //public static final String NOMINA_QUERY = "SELECT 1 HZRNNOM_ESTADO FROM DUAL WHERE HZRNNOM_ESTADO IS NULL";
            public static final String NOMINA_QUERY = "SELECT 1 HZRNNOM_ESTADO, 2 HZRNNOM_CUNE_INTERNO, 3 HZRNNOM_PREFIJO, 4 HZRNNOM_NUM_DOC, 5 HZRNNOM_BASE64_PDF FROM DUAL";
    ...
    //public static final String HZRNITE_QUERY = "SELECT HZRNITE_CUNE_INTERNO, HZRNITE_DIAS_TRAB, HZRNITE_SUELDO_TRAB,HZRNITE_ID FROM UPB_NOMINAE.HZRNITE";
            public static final String HZRNITE_QUERY = "SELECT 1 HZRNITE_CUNE_INTERNO, 2 HZRNITE_DIAS_TRAB, 3 HZRNITE_SUELDO_TRAB,4 HZRNITE_ID FROM DUAL";
    
    //public static final String HZRNETR_QUERY = "SELECT HZRNETR_AUX_TRANSPORTE, HZRNETR_VIAT_MANUT_SALARIAL, HZRNETR_VIAT_MANUT_NO_SALARIAL,HZRNETR_ITE_ID FROM UPB_NOMINAE.HZRNETR";
            public static final String HZRNETR_QUERY = "SELECT 1 HZRNETR_AUX_TRANSPORTE, 2 HZRNETR_VIAT_MANUT_SALARIAL, 3 HZRNETR_VIAT_MANUT_NO_SALARIAL, 4 HZRNETR_ITE_ID FROM DUAL";
